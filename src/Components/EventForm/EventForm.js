    ...
    <form className="form-container" onSubmit={handleSubmit}>
        ...
        <div className="location-options">
          <label
            className={`location-option ${
              locationType === "Physical" && "selected"
            }`}
          >
            <input
              type="radio"
          ...
          <input
            ...
            placeholder={
              locationType === "Physical"
                ? "Add an address or venue name..."
                : "eg: Virtual Event, Conference"
            }
            value={locationValue}
      ...
      <div className="image-upload">
        ...
        <label htmlFor="file-upload" className="upload-label">
          <input id="file-upload" type="file" onChange={handleImageUpload} required/>
        </label>
      </div>
